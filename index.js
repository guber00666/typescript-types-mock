...
switch (platform) {
  ...
  case 'win32':
    switch (arch) {
      case 'x64':
        localFileExisted = existsSync(
          join(__dirname, 'typescript-types-mock.win32-x64-msvc.node')
        )
        try {
          if (localFileExisted) {
      ...
      case 'ia32':
        localFileExisted = existsSync(
          join(__dirname, 'typescript-types-mock.win32-ia32-msvc.node')
        )
        try {
          if (localFileExisted) {
      ...
      case 'arm64':
        localFileExisted = existsSync(
          join(__dirname, 'typescript-types-mock.win32-arm64-msvc.node')
        )
        try {
          if (localFileExisted) {
    ...
    break
  case 'darwin':
    localFileExisted = existsSync(join(__dirname, 'typescript-types-mock.darwin-universal.node'))
    try {
      if (localFileExisted) {
        nativeBinding = require('./typescript-types-mock.darwin-universal.node')
      } else {
        nativeBinding = require('typescript-types-mock-darwin-universal')
      }
      break
    } catch {}
    switch (arch) {
      ...
      case 'arm64':
        localFileExisted = existsSync(
          join(__dirname, 'typescript-types-mock.darwin-arm64.node')
        )
        try {
          if (localFileExisted) {
  ...
  case 'linux':
    switch (arch) {
      case 'x64':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'typescript-types-mock.linux-x64-musl.node')
          )
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(
            join(__dirname, 'typescript-types-mock.linux-x64-gnu.node')
          )
          try {
            if (localFileExisted) {
      ...
      case 'arm64':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'typescript-types-mock.linux-arm64-musl.node')
          )
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(
            join(__dirname, 'typescript-types-mock.linux-arm64-gnu.node')
          )
          try {
            if (localFileExisted) {
      ...
      case 'arm':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'typescript-types-mock.linux-arm-musleabihf.node')
          )
          try {
            if (localFileExisted) {
              nativeBinding = require('./typescript-types-mock.linux-arm-musleabihf.node')
            } else {
              nativeBinding = require('typescript-types-mock-linux-arm-musleabihf')
            }
          } catch (e) {
            loadError = e
          }
          ...
          localFileExisted = existsSync(
            join(__dirname, 'typescript-types-mock.linux-arm-gnueabihf.node')
          )
          try {
            if (localFileExisted) {
      ...
      case 'riscv64':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'typescript-types-mock.linux-riscv64-musl.node')
          )
          try {
            if (localFileExisted) {
              nativeBinding = require('./typescript-types-mock.linux-riscv64-musl.node')
            } else {
              nativeBinding = require('typescript-types-mock-linux-riscv64-musl')
            }
          } catch (e) {
            loadError = e
          }
          ...
          localFileExisted = existsSync(
            join(__dirname, 'typescript-types-mock.linux-riscv64-gnu.node')
          )
          try {
            if (localFileExisted) {
              nativeBinding = require('./typescript-types-mock.linux-riscv64-gnu.node')
            } else {
              nativeBinding = require('typescript-types-mock-linux-riscv64-gnu')
            }
          } catch (e) {
            loadError = e
          }
      ...
      case 's390x':
        localFileExisted = existsSync(
          join(__dirname, 'typescript-types-mock.linux-s390x-gnu.node')
        )
        try {
          if (localFileExisted) {
            nativeBinding = require('./typescript-types-mock.linux-s390x-gnu.node')
          } else {
            nativeBinding = require('typescript-types-mock-linux-s390x-gnu')
          }
        } catch (e) {
          loadError = e
        }
